...
/** Tests the class {@link ReplicationMetacardGroomerPlugin} */
public class ReplicationMetacardGroomerPluginTest {
  ...
  private ReplicationMetacardGroomerPlugin plugin;

  @Before
  public void setUp() {
    uuidGenerator = mock(UuidGenerator.class);
    when(uuidGenerator.generateUuid()).thenReturn(UUID.randomUUID().toString());
    plugin = new ReplicationMetacardGroomerPlugin();
    plugin.setUuidGenerator(uuidGenerator);
    subject = mock(Subject.class);
    subjectOperations = mock(SubjectOperations.class);
    plugin.setSubjectOperations(subjectOperations);
  }
  ...
  public void testCreateStandardWithIdNoUri()
    ...
    String id = UUID.randomUUID().toString();
    when(uuidGenerator.validateUuid(any(String.class))).thenReturn(true);
  ...
  public void testCreateNoTitleNull()
    ...
    when(subjectOperations.getEmailAddress(subject)).thenReturn("user@place.com");
  ...
  private Metacard processCreate(Metacard inputMetacard)
    ...
    inputRequest.getProperties().put(SecurityConstants.SECURITY_SUBJECT, subject);
