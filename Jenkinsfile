    ...
    stages {
        ...
        stage('Incremental Build') {
            ...
            steps {
                ...
                withMaven(maven: 'maven-latest', jdk: 'jdk8-latest', globalMavenSettingsConfig: 'default-global-settings', mavenSettingsConfig: 'replication-maven-settings-file', mavenOpts: '${LINUX_MVN_RANDOM}') {
                    sh '''
