...
public class CswResponseExceptionMapperTest {
  ...
  public void testCswExceptionWithNullResponse() {
    AdapterException cswException = new CswResponseExceptionMapper().fromResponse(null);
  ...
  public void testCswExceptionWithInvalidEntityType() {
    ...
    AdapterException cswException = new CswResponseExceptionMapper().fromResponse(response);
  ...
  public void testEmptyCswException() {
    ...
    AdapterException cswException = createCswException(exceptionReportXml);

    assertThat(cswException.getMessage(), containsString("Csw exception: "));
  }
  ...
  public void testCswExceptionWithCodeOnly() {
    ...
    assertThat(cswException.getMessage(), containsString("INVALID_PARAMETER_VALUE"));
  ...
  public void testCswExceptionWithLocatorOnly() {
    ...
    assertThat(cswException.getMessage(), containsString("QueryConstraint"));
    assertThat(
        cswException.getMessage(),
        containsString(
            "Only dc:title,dct:modified,dc:subject,dct:dateSubmitted,dct:alternative,dc:format,dct:created,dc:type,dct:abstract,dc:identifier,dc:creator  are currently supported"));
  ...
  private AdapterException createCswException(String exceptionReportXml) {
