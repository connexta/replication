...
/** A query request object to be sent to {@link NodeAdapter}s to fetch {@link Metadata}. */
public interface QueryRequest {
   ...
   * the {@link Metadata}s lineage contains the {@link NodeAdapter}s name, it should not be returned
   * in the query.
   *
  ...
  /**
   * A list of {@link Metadata} IDs that have failed to be replicated between {@link NodeAdapter}s
   * by the {@link Replicator}.
   *
