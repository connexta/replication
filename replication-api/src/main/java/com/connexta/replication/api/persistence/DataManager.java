...
public interface DataManager<T extends Persistable> {
   ...
   * @throws ReplicationPersistenceException if any other error occurs while trying to retrieve the
   *     object
   ...
   * @throws NotFoundException if an object with the given id cannot be found
   * @throws ReplicationPersistenceException if any other error occurs while trying to delete the
   *     object
   */
