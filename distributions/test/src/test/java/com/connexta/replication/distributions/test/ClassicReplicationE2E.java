...
public class ClassicReplicationE2E {

  private static final Logger LOGGER = LoggerFactory.getLogger(ClassicReplicationE2E.class);
  ...
  public static GenericContainer replication = defaultReplicationContainer(network, "Classic");
