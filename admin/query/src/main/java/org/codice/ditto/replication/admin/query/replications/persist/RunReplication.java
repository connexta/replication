...
public class RunReplication extends BaseFunctionField<BooleanField> {

  public static final String FIELD_NAME = "runReplication";

  public static final String DESCRIPTION = "Runs a replication. Run a replication job right now";
  ...
  public RunReplication(ReplicationUtils replicationUtils) {
  ...
  public BooleanField performFunction() {
    ...
    successful.setValue(replicationUtils.runConfig(id.getValue()));
  ...
  public FunctionField<BooleanField> newInstance() {
    return new RunReplication(replicationUtils);
  }
