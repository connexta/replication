        ...
        >
          ...
          <DialogContent>
            ...
            <TextField
              ...
              fullWidth
              helperText='The path under which the replication services can be found. Typically this is under `services` for DDF based nodes, and `/webhdfs/v1/<directoryPath>` for webHDFS based nodes.'
              value={rootContext}
            />
          </DialogContent>
          <DialogActions>
